...
const features = [
  {
    ...
    description:
      "Leverage advanced AI algorithms to accelerate the drug discovery process and identify promising candidates.",
    icon: Dna,
    href: "/dashboard",
  ...
  },
  {
    ...
    description:
      "Utilize state-of-the-art molecular modeling and simulation tools for precise drug-target interactions.",
    icon: Microscope,
    href: "/dashboard",
  ...
  },
  {
    ...
    description:
      "Advance personalized healthcare solutions by analyzing patient-specific data with AI algorithms.",
    icon: Pill,
    href: "/dashboard",
    ...
    >
      <AnimationContainer>
        ...
        >
          ...
          >
            Swasthya Darpan AI empowers you to revolutionize healthcare
            research. Experience cutting-edge, AI-driven solutions that adapt to
