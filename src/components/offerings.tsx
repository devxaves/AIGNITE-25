      ...
      <AnimationContainer>
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Accelerating drug discovery and improving patient outcomes through
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button
              variant="outline"
              className="bg-gradient-to-r from-purple-600 to-blue-700 mt-8 py-6 rounded-full w-full text-lg"
              asChild
            >
