  ...
  return (
    <AnimationContainer delay={delay}>
      <motion.div
        ...
        whileHover={{
          scale: 1.05,
          boxShadow: "0 25px 50px -12px rgba(0, 0, 255, 0.5)",
        }}
        whileTap={{ scale: 0.98 }}
      ...
      >
        ...
        <div className="relative z-10 bg-blue-900 bg-opacity-20 backdrop-blur-sm p-8">
          ...
          <h3 className="mb-4 font-bold text-2xl text-white tracking-wide">
            {title}
          </h3>
          ...
          >
            ...
            <div className="relative z-10 bg-indigo-900 bg-opacity-30 backdrop-blur-sm p-8 rounded-2xl">
              ...
              <p className="mb-8 max-w-3xl text-2xl text-gray-100 leading-relaxed">
                Explore Swasthya Darpan: Our AI-powered platform designed to
                accelerate breakthroughs in healthcare and drug discovery.
              </p>
              <Link href="/dashboard" passHref>
                <motion.a
