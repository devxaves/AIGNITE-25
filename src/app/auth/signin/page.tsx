...
const SignInPage = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-indigo-950/25 to-purple-950/25  p-4 sm:p-6 md:p-8">
            <div className="w-full max-w-md bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden border border-white border-opacity-20 p-8 space-y-8">
                <div className="flex flex-col text-center gap-3">
                    ...
                    <h1 className="text-4xl font-extrabold p-2 font-heading mt-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-600">
                        Sign In
                    </h1>
                    <p className="text-blue-600 text-opacity-80 text-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                        <Label htmlFor="email" className="text-black text-opacity-90 text-lg font-semibold">
                            Email address
                        </Label>
                        <Input
                            id="email"
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="password" className="text-black text-opacity-90 text-lg font-semibold">
                            Password
                        </Label>
                    ...
                    <Button
                        ...
                        size="lg"
                        disabled={isLoading}
                        className="w-full bg-gradient-to-r from-blue-600 hover:from-blue-700 to-purple-600 hover:to-purple-700 hover:shadow-xl text-white font-bold py-3 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300"
                    >
                        {isLoading ? (
                ...
                <div className="text-center">
                    <p className="text-white text-opacity-80 text-lg">
                        ...
                        <Link href="/auth/signup" className="text-blue-600 hover:text-blue-100 font-semibold underline transition-colors duration-300">
                            Sign Up
                        </Link>
                    </p>
                </div>
